========================================================================
    コンソール アプリケーション: BouyomiReplaceTagGenerator プロジェクトの概要
========================================================================

この BouyomiReplaceTagGenerator アプリケーションは、AppWizard により作成されました。

このファイルには、BouyomiReplaceTagGenerator アプリケーションを構成する各ファイルの内容の概要が含まれています。


BouyomiReplaceTagGenerator.vcxproj
...
BouyomiReplaceTagGenerator.vcxproj.filters
...
BouyomiReplaceTagGenerator.cpp
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、BouyomiReplaceTagGenerator.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
